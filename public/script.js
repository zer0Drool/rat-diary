...
function readDiary() {
    ...
    if (diary[diaryCount] === 'LOADING') {
        ...
        clearInterval(diaryInt);
        damageInt = setInterval(ouch, 300);
        ...
        p.classList.add('fade');
        terminal.appendChild(p);
    } else if (diary[diaryCount].indexOf('rat tail ) ~ lost') !== -1) {
        clearInterval(flexInt);
        flexCount = 0;
        emoticons[1].children[0].innerText = '';
        ...
        p.classList.add('fade');
        terminal.appendChild(p);
        fightInt = setInterval(fight, 120);
        ...
        p.classList.add('fade');
        terminal.appendChild(p);
    } else if (diary[diaryCount] === 'filtering duplicate files') {
        clearInterval(diaryInt);
        let p = document.createElement('p');
        p.innerText = diary[diaryCount];
        p.classList.add('fade');
...
// ≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠≠
    ...
    function percent(text) {
        ...
        percentage = percentage * randoPercentage(2.5, 1.1);
...
function join() {
    ...
    emoticons[0].children[0].innerText = joiningAI[joinCount];
    emoticons[1].children[0].innerText = joiningRat[joinCount];

    joinCount++;
    if (joinCount === joiningAI.length) {
        emoticons[0].children[0].innerText = '';
        emoticons[1].children[0].innerText = '';
        joinCount = 0;
...
function flex() {
    ...
    emoticons[1].children[0].innerText = flexing[flexCount];

    flexCount++;
    if (flexCount === flexing.length) {
        flexCount = 0;
    };
...
function weak() {
    ...
    emoticons[1].children[0].innerText = weaking[weakCount];

    weakCount++;
    if (weakCount === weaking.length) {
        weakCount = 0;
    };
...
function fight() {
    ...
    emoticons[0].children[0].innerText = fightingAI[fightCount];
    emoticons[1].children[0].innerText = fightingRat[fightCount];
    
    fightCount++;
    if (fightCount === fightingAI.length) {
        fightCount = 0;
...
function randoPercentage(max, min) {
